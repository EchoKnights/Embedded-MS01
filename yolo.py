...
def main():
    ...
    # --- open serial (optional: fail gracefully) ---
    ser = None
    try:
        ser = serial.Serial("COM4", 115200, timeout=0.1)
        time.sleep(0.2)  # give it a moment
        print("Serial OK on COM4")
    except Exception as e:
        print(f"[WARN] Serial not available on COM4: {e}")
        print("[WARN] Continuing WITHOUT serial output...")
