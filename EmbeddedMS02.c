...
//     float last_reading;
//     uint64_t now;
//     uint64_t last_seen = to_ms_since_boot(get_absolute_time());
//     uint64_t in_range = to_ms_since_boot(get_absolute_time());
...
//         reading = get_webcam_detection();
//         // if(!(now - last_seen <= acceptable_drop)){
//         //     printf("Accepting Input: %d\n", (now - last_seen));
//         //     switch ((int)reading){
//         //     case 500:
//         //         lcd_clear(I2C_PORT);
//         //         lcd_print(I2C_PORT, "BOOM");
//         //         break;
//         //     case 404:
//         //         lcd_clear(I2C_PORT);
//         //         lcd_print(I2C_PORT, "NO INPUT");
//         //         break;
//         //     default:
//         //         last_seen = now;
//         //         char buffer[50];
//         //         snprintf(buffer, sizeof(buffer), "DISTANCE: %.1fCM", reading);
...
//         // }else if(reading != 500 && reading != 404){
//         //     printf("Last Reading: %d", reading);
//         //     last_reading = reading;
//         // }
...
//         // if(!( (int) last_reading >= value - 2 && (int) last_reading <= value + 2 )){
//         //     in_range = to_ms_since_boot(get_absolute_time());
//         //     printf("In range: %d\n", in_range);
//         // }

//         // if(now - in_range >= 5000){
//         //     threshold = true;
//         //     motors_stop(MOT_FWD, MOT_REV); 
//         // }
//         // printf("Time so far: %d\n", (now - in_range));
//         printf("Simple Test: %f\n", reading);
//     }
